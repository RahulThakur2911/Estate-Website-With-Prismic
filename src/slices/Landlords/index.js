...
const Landlords = ({ slice }) => {
  ...
  console.log('Image', slice.variation);
  

  return (

    <>
    {slice.variation === "default" &&  <section
      className={`max-w-[1440px] w-full font-sans flex flex-col md:flex-row items-center justify-center md:justify-between bg-white mx-auto py-[70px] xl:py-[100px] px-[30px] xl:px-[160px] ${
        isImageRight ? "flex md:flex-row-reverse" : "flex md:flex-row"
      }`}
    >
      {/* Image Container */}
      <div className="relative flex justify-center mb-7 md:mb-0 items-center w-full max-w-[544px]">
        <PrismicNextImage field={primary?.landlordimage} />
        ...
        <div className="absolute inset-x-0 bottom-[-30px] mx-6 flex items-center justify-center">
          <div className="flex items-center w-full max-w-[411px] bg-white shadow-md rounded-[8px] border border-gray-200 p-2 md:p-4 relative">
            <div className="absolute -top-4 right-6 flex items-center justify-center w-12 h-12">
              <PrismicNextImage field={primary?.smallimage} />
            </div>
        ...
        <div className="flex items-center justify-center w-full max-w-[327px]">
          <div className="flex items-center justify-center border-[2px] bg-[#EFEFFB] border-[#DEDEF7] px-2 py-2 shadow-md">
            <button
              ...
              className={`px-6 py-2 text-[16px] font-bold leading-6 focus:outline-none transition ${
                activeTab === "tenants"
    ...
    {slice.variation === 'imageRight' &&  <section
      className="max-w-[1440px] w-full font-sans flex flex-col md:flex-row items-center justify-center md:justify-between bg-white mx-auto py-[70px] xl:py-[100px] px-[30px] xl:px-[160px]"
      style={isImageRight ? { flexDirection: 'row-reverse' } : {}}
    >
      {/* Image Container */}
      <div className="relative flex justify-center mb-7 md:mb-0 items-center w-full max-w-[544px]">
        <PrismicNextImage field={primary?.landlordimage} />
